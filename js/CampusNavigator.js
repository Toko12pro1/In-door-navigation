// Main application class - Campus Navigator
class CampusNavigator {
    constructor() {
        ...
        this.mapController = new MapController(this.roomDataManager, this.analytics);
