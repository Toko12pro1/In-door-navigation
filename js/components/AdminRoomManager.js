...
class AdminRoomManager {
            ...
            <div class="modal-content room-modal">
                ...
                <form class="room-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="room-image" value="${roomData?.image || ''}" placeholder="https://example.com/image.jpg">
                    </div>
    ...
    saveRoom(roomId, modal) {
        const formData = {
            ...
            image: modal.querySelector('#room-image').value || 'https://images.pexels.com/photos/1181354/pexels-photo-1181354.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        ...
        if (window.campusNavigator?.showNotification) {
            window.campusNavigator.showNotification(
    ...
    deleteRoom(roomId) {
        ...
        if (confirm(`Are you sure you want to delete "${room.name}"? This action cannot be undone.`)) {
            ...
            // Show success notification
            if (window.campusNavigator?.showNotification) {
                window.campusNavigator.showNotification('Room deleted successfully!', 'success');
            }
        }
    }
}