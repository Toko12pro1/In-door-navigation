...
class RoomInfoPanel {
    ...
    show(roomId, position = null) {
        ...
        roomImage.src = roomInfo.image || 'https://images.pexels.com/photos/1181354/pexels-photo-1181354.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop';
        roomImage.alt = `${roomInfo.name} - Room Image`;
    ...
    highlightRoom(roomId) {
        ...
        if (select) {
            ...
            if (window.campusNavigator?.mapController?.highlightSelected) {
                window.campusNavigator.mapController.highlightSelected();
            }
    ...
    generateDirections(roomInfo) {
        ...
        const typeSpecificInstructions = {
            ...
            'Storage': '📦 Restricted access areas, usually marked with storage signs'
        };
